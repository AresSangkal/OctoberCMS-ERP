        ...
        $.ajax(
                {
                    ...
                    success: function (res) {
                        if (res == 1) {
                            $('#show_contact_msg').html('<div class=gen><i class="fa fa-smile-o" aria-hidden="true"></i> Thank you very much, We will replay you soon.</div>');
                            $("#contact-form")[0].reset();
                        }

                        if (res == 5) {
                            $('#show_contact_msg').html('<div class=err><i class="fa fa-frown-o" aria-hidden="true"></i> Message has not been send.</div>');
                        }
                    }
                });
        e.preventDefault();
...
$(document).ready(function () {
    ...
    $('div.imagebox').zoom({
        ...
        url: 'img/about/GCC-ORGANIZATIONCHART-1.jpg',
